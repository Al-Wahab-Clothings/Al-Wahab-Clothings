    ...
    return (
        <div className="flex flex-col gap-y-2">
            ...
            <div className="flex flex-col gap-y-2">
                <div
                    key={item.id}
                    className="w-full bg-[#D6CFB4] p-4 flex flex-col sm:flex-row items-center justify-between gap-4"
                >
                    ...
                    {/* quantity */}
                    <div className="flex items-center justify-center gap-x-3 border-[1px] border-white py-2 px-4 w-full md:w-auto">
                        <p>Quantity</p>
                    ...
                    <div className="w-full md:w-1/3 flex items-end justify-center sm:justify-end">
